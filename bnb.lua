...
local themeStyles = {
    ...
    ReboundTheme = {
        SchemeColor = Color3.fromRGB(75, 171, 98),
        Background = Color3.fromRGB(75, 171, 98),
        Header = Color3.fromRGB(75, 171, 98),
        TextColor = Color3.fromRGB(0,0,0),
        ElementColor = Color3.fromRGB(75, 171, 98)
    },
    BloodTheme = {
...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "ReboundTheme" then
        themeList = themeStyles.LightTheme
